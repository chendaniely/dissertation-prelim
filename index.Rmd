...
In 2020,
89% of all hospitals have implemented an electronic health record system creating
2,314 exabytes of new medical data
since the Health Information Technology for Economic and Clinical Health (HITECH) Act's
Electronic Health Records - Meaningful Use (EHR-MU) clause of 2009 [@@stewartHealthcareDataVolume2020; @DoesHospitalEHR; @rightsocrHITECHActEnforcement2009; @HITECHActSummary; @HealthITLegislation].
This sheer volume of health data
...
While EHR systems have their own data challenges, the influx of
electronic data has called for changes in how clinicians undergo training to
meet the challenges of evidenced-based medicine by using these data [@AcceleratingChangeMedical; jenniferbresnickHealthcareBigData2015].
By
...
We hypothesize that learning materials with an eye towards tidy data principles is an effective way to teach the data science and data literacy skills that will help learners incorporate programming and data science skills from their spreadsheet workflows.
We will be using a series of lognitudinal surveys along with a data science curriculum that we will create
