...
project <- tibble::tribble(
  ...
  "Aim 3: Assess formative assessments", "3.1: Implement an experiment", 7, 9,
  "Aim 3: Assess formative assessments", "3.2: Assess the effectiveness of targeted feedback", 10, 22,
)
